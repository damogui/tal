...
public class Employee extends ArchiveEntity {
    ...
    @Encryption
    @Column(name="mobile",header="移动电话")
	...
	@Column(name="login_name",header="登陆名称")
    ...
    @Subs(subType=EmployeeCity.class,foreignKey="employeeId",header="影响城市")
    private List<EmployeeCity> citys;

	public List<EmployeeCity> getCitys() {
		return citys;
	}
	public void setCitys(List<EmployeeCity> citys) {
		this.citys = citys;
	}
