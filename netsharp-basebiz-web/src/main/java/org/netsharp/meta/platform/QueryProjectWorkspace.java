...
//			formField.setTroikaTrigger("resourceNodeChange(newValue, oldValue);");
	...
	protected void addDetailGridPart(PWorkspace workspace) {
		...
		addColumn(datagrid, "customerControlType", "自定义控件", ControlTypes.TEXT_BOX, 100);
	...
	protected PForm createDetailGridForm(ResourceNode node) {
		...
		addFormField(form, "customerControlType", "自定义控件", null, ControlTypes.TEXT_BOX, false, false);
