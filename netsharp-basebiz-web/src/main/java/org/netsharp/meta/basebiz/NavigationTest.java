...
public class NavigationTest extends NavigationBase {
	...
	public void createAccodions() {
		...
		this.doCreateAccodions("system", "系统管理", "fa fa-cog fa-fw", 10000);
	}

	@Override
	protected void doCreateTree(PNavigation tree) {

		createPTreeNode(tree, null, "fa fa-sitemap fa-fw", "system-organization", "组织机构", "");
		{
		...
		createPTreeNode(tree, null, "fa fa-toggle-on fa-fw", "system-authorization", "权限管理", "");
		{
			...
			createPTreeNode(tree, "system-authorization", null, OperationAuthorizationLog.class.getSimpleName(), "授权日志",
					"/system/authorization/log/list");
		}

		createPTreeNode(tree, null, "fa fa-cog fa-fw", "system-options", "系统选项", "");
		{
