 ...
 *
 */
public class OrganizationFilterReferenceTest extends ReferenceCreationBase{

	@Before
	public void setup() {
		
		resourceNodeCode =  Organization.class.getSimpleName();
		datagridName = referenceName = "部门参照【自定义条件】";
		referenceCode = "Organization-Department-Filter";
		intelligentMode = IntelligentMode.LIKE;
		intelligentFields = "pathName";
		gridFilter = "organizationType != 'Post'";
