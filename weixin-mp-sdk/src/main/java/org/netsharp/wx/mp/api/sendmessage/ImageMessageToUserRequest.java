...
//[Api("发送消息到用户.图片")]
public class ImageMessageToUserRequest extends SendMessageToUserRequest
{
...
//		var jsonData = new { touser = this.getOpenIds(), image = new { media_id = this.getMediaId() }, msgtype = "image" };
//
//		return jsonData;
	}
}