...
import org.netsharp.wx.mp.message.request.ImageRequest;
import org.netsharp.wx.mp.message.request.LinkRequest;
import org.netsharp.wx.mp.message.request.LocationRequest;
import org.netsharp.wx.mp.message.request.TextRequest;
import org.netsharp.wx.mp.message.request.VideoRequest;
import org.netsharp.wx.mp.message.request.VoiceRequest;
import org.netsharp.wx.mp.message.request.event.EventRequest;
import org.netsharp.wx.mp.message.request.event.KfEventRequest;
import org.netsharp.wx.mp.message.request.event.LocationEvent;
import org.netsharp.wx.mp.message.request.event.MassSendFinishEvent;
import org.netsharp.wx.mp.message.request.event.SubscribeEvent;
import org.netsharp.wx.mp.util.WeixinUtil;
