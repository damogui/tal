package org.netsharp.wx.mp.api.oauth;
...
import org.netsharp.wx.mp.WebClient;
...
public class OAuthRequest extends Request<OAuthResponse> {
    ...
    @Override
    public OAuthResponse getResponse() throws NetsharpException {
    ...
    @Override
    protected OAuthResponse doResponse() throws NetsharpException {
