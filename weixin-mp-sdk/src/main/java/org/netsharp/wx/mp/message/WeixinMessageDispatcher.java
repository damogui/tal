...
import org.netsharp.wx.mp.sdk.SHA1;
import org.netsharp.wx.mp.sdk.WeixinRequestParameters;
...
public class WeixinMessageDispatcher {
	...
	private static Log logger = LogFactory.getLog("weixin." + WeixinMessageDispatcher.class.getSimpleName());
