...
public class WebClient {
    ...
    public String downloadString(String url) throws NetsharpException {
...
//			http.disconnect();
    ...
    public byte[] downloadData(String url, String str) throws NetsharpException {
