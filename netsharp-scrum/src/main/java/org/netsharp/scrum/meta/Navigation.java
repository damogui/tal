...
public class Navigation extends NavigationBase {
	...
	protected void doCreateTree(PNavigation tree) {
		...
		createPTreeNode(tree, null, "", "iteration", "迭代管理", "", 2);
		{
		...
		createPTreeNode(tree, null, "", "days", "日常管理", "", 3);
		{
		...
		createPTreeNode(tree, null, "", "product", "产品项目", "", 4);
		{
		...
		createPTreeNode(tree, null, "", "bug", "缺陷管理", "", 5);
		{
