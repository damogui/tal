...
public class IterationNextStoryWorkspaceTest extends StoryWorkspaceTest{
	@Override
	@Before
	public void setup() {		
		// 在子类中重定义
		urlList = "/scrum/story/nextIterationProject/list";
		...
		resourceNodeCode="nextIterationProject";
		entity = Story.class;
		meta = MtableManager.getMtable(entity);
		listPartName =formPartName= "下迭代任务";
