...
public class Workspace extends HtmlPage {
	...
	protected void importCss(IHtmlWriter writer) {
		...
		writer.write("<meta name=\"Keywords\" content=\""+Application.getContext().getName()+"\"/>");
		writer.write("<meta name=\"Description\" content=\""+Application.getContext().getName()+"\"/>");
	...
	protected void importJs(IHtmlWriter writer) {
		...
		writer.write(UrlHelper.getVersionScript("/package/easyui/jquery.easyui.patch.js"));
