...
import com.gongsibao.taurus.util.SmsHelper;
...
//    private static Log    logger      = LogFactory.getLog(WebClient.class);
    ...
    public String downloadString(String url) throws TaurusException {
...
//            logger.info("request_post:" + str);
        	...
        	System.out.println("request_post:" + str);
        	...
        	String [] mobiles = {"1331503086","15801526621","18613804375"};
        	SmsHelper.send(mobiles, "您好，泰尔数据接口出现故障！");
            throw new TaurusException(e);
        }
    }

    public byte[] downloadData(String url, String str) throws TaurusException {
