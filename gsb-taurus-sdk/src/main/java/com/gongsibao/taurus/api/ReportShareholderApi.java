...
import com.gongsibao.taurus.message.response.ReportShareholderResponseMessage;
import com.gongsibao.taurus.util.ConfigHelper;
import com.gongsibao.taurus.util.MD5Util;

public class ReportShareholderApi extends AbstractApi<ReportShareholderResponseMessage> {
	...
	public String getUrl() {
		...
		return "/data/api/companyInfo/pageReportShareholder";
	}

	@Override
	public Class<?> getResponseType() {

		return ReportShareholderResponseMessage.class;
	}
}
