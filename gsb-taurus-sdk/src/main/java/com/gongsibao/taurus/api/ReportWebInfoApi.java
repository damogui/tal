...
import com.gongsibao.taurus.message.response.ReportWebInfoResponseMessage;
import com.gongsibao.taurus.util.ConfigHelper;
import com.gongsibao.taurus.util.MD5Util;

public class ReportWebInfoApi extends AbstractApi<ReportWebInfoResponseMessage> {
	...
	public String getUrl() {
		...
		return "/data/api/companyInfo/pageReportWebInfo";
	}

	@Override
	public Class<?> getResponseType() {

		return ReportWebInfoResponseMessage.class;
	}
}
