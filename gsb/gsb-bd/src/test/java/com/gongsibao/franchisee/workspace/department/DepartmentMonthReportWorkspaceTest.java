...
import com.gongsibao.franchisee.web.DepartmentMonthReportController;
...
public class DepartmentMonthReportWorkspaceTest  extends WorkspaceCreationBase{
	...
	public void setup() {
		...
		urlList = "/bd/department/month/report";
		...
		listFilter="type=2";
		// 扩展
		listPartServiceController =  DepartmentMonthReportController.class.getName();
		listPartJsController = DepartmentMonthReportController.class.getName();
		listPartImportJs = "/gsb/bd/js/departReport/month.report.part.js";
	...
	protected PDatagrid createDatagrid(ResourceNode node) {
	 ...
	 /* @Override 
	  protected PQueryProject createQueryProject(ResourceNode node) {
		  ...
		  queryProject.toNew(); 
		  PQueryItem item = addQueryItem(queryProject, "date", "月份",ControlTypes.MONTH_BOX);{
