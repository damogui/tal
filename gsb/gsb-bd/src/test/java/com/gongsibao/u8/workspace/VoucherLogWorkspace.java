...
public class VoucherLogWorkspace extends WorkspaceCreationBase {
	...
	protected PDatagrid createDatagrid(ResourceNode node) {
		...
		addColumn(datagrid, "sender", "eai配置系统注册码", ControlTypes.TEXT_BOX, 80);
		addColumn(datagrid, "orderNo", "订单编号", ControlTypes.TEXT_BOX, 100);		
		addColumn(datagrid, "payId", "支付编号", ControlTypes.NUMBER_BOX, 100);
		addColumn(datagrid, "refundId", "退单退款编号", ControlTypes.TEXT_BOX, 100);
		addColumn(datagrid, "inVoucherLogId", "确认收入凭证源记录Id", ControlTypes.TEXT_BOX, 100);
		...
		addColumn(datagrid, "succeed", "u8成功标识(0:成功;非0:失败)", ControlTypes.TEXT_BOX, 100);
