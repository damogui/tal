...
public class Tools {
	...
	private String prefix = "er_";
	private String pakcageName = "com.gongsibao.er";
	private String indent = "    ";
	private String dir = "E:/gsb/repo/ma/new-netsharp/gsb-er/src/main/java/com/gongsibao/er";
	...
	public void queryTable() throws IOException {
		...
		DataTable table = dao.executeTable(
				"select * from information_schema.tables t where t.table_schema='my_netsharp' and table_name like '" + prefix
						+ "%'",
				null);
	...
	private void generateEntity(DataTable table) throws IOException {
		...
		builder.append("package " + this.pakcageName + ".entity;" + StringManager.NewLine);
		builder.append(StringManager.NewLine);
		builder.append("import com.gongsibao.basebiz.entity.BaseEntity;" + StringManager.NewLine);
