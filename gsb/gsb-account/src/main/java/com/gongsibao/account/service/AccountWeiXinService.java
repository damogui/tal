    ...
    public void pushOrderStateMsg(String originalId,String mobile, Integer orderPorudctId) {
        ...
        try {
            ...
            if (null != proName && null != proTrace) {
                ...
                this.pushTextMsgByOriginalId(originalId,account.getId(),"尊敬的"+accountWeiXin.getNickname()+":",orderNo,proTrace,null,"/index.html#/mine/order",proName,AccountWxMsg.ORDER_STATE_CHANGE);
            }
