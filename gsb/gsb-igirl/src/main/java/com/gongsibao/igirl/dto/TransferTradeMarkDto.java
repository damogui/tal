...
public class TransferTradeMarkDto {
    ...
    private String acceptPerson;//国内接收人

    private String acceptAddr;//国内接收人地址
    ...
    private String scertType;//受让人证件名称

    private String scertNo;//受让人证件号码

    private String zrSfCnTrName;//转让人身份证明文件(中文)

    private String srSfCnTrName;//受让人身份证明文件(中文)

    private String zrSfEnTrName;//转让人身份证明文件(外文)

    private String srSfEnTrName;//受让人身份证明文件(外文)
    ...
    private String fileYgName;//有关说明文件
    ...
    public String getAssigneeGjdq() {
        return assigneeGjdq;
    }

    public void setAssigneeGjdq(String assigneeGjdq) {
    ...
    public String getZdllx() {
        return zdllx;
    }

    public void setZdllx(String zdllx) {
        this.zdllx = zdllx;
    }

    public String getSdjlx() {
        return sdjlx;
    }

    public void setSdjlx(String sdjlx) {
        this.sdjlx = sdjlx;
    }

    public String getZwjlx() {
        return zwjlx;
    }

    public void setZwjlx(String zwjlx) {
        this.zwjlx = zwjlx;
    }
