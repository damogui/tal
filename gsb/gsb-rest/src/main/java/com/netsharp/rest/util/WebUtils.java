package com.netsharp.rest.util;
...
public abstract class WebUtils {
    ...
    public static final String DOMAIN_NET = "gongsibao.com";
    public static final String DOMAIN_BEEHIVE_NET = "beehive" + DOMAIN_NET;
    public static final String DOMAIN_DING = "mycom.hz.taeapp.com";
    ...
    public static void removeCookieNet(HttpServletResponse response, String key) {
        ...
        saveCookie(response, key, "", 0, "/", DOMAIN_BEEHIVE_NET);
    }

    public static void setCookieCom(HttpServletResponse response, String key, String value, int age) {
        saveCookie(response, key, value, age, "/", DOMAIN_DING);
        saveCookie(response, key, value, age, "/", DOMAIN_COM);
        saveCookie(response, key, value, age, "/", null);
    }

    public static void removeCookieCom(HttpServletResponse response, String key) {
        setCookieCom(response, key, "", 0);
        saveCookie(response, key, "", 0, "/", "s" + DOMAIN_COM);
    }

    public static void setERCookie(HttpServletResponse response, String key, String value, int age) {
        saveCookie(response, key, value, age, "/", DOMAIN_COM);
        saveCookie(response, key, value, age, "/", DOMAIN_NET);
        saveCookie(response, key, value, age, "/", null);
    }

    public static void removeERCookie(HttpServletResponse response, String key) {
        saveCookie(response, key, "", 0, "/", DOMAIN_COM);
        saveCookie(response, key, "", 0, "/", DOMAIN_NET);
        saveCookie(response, key, "", 0, "/", null);
    }
