...
//    public ResponseData clear(HttpServletRequest request, HttpServletResponse response) {
//        cacheService.delete(ConstantCache.DIC_KEY);
...
////        leafIds.add(101110100);
////        leafIds.add(101110112);
////        leafIds.add(101110113);
////        leafIds.add(101350300);
////        leafIds.add(101350000);
////        leafIds.add(101120000);
////        //List<BdDict> list = bdDictService.queryParentsByLeafIds(101, leafIds);
////        List<BdDict> list = bdDictService.queryTopParentsByLeafIds(101, leafIds);
////        ResponseData data = new ResponseData();
////        if(CollectionUtils.isEmpty(list)){
////            data.setCode(-1);
////            data.setMsg("操作失败");
...
//    }
//
//    @RequestMapping("/orderOperateStatuses")
//    public ResponseData orderStatuses(HttpServletRequest request, HttpServletResponse response) {
//        ResponseData data = new ResponseData();
//        List<OrderOperateStatus> opStatusList = OrderOperateStatus.getAllStatus();
//        List<Map<String, Object>> list = new ArrayList<>();
//
//        for (OrderOperateStatus allStatus : opStatusList) {
//            Map<String, Object> map = new HashMap<>();
//            list.add(map);
//
//            map.put("pkid", allStatus.getPkid());
//            map.put("name", allStatus.getName());
//            map.put("dictId", allStatus.getDictId());
//        }
//        data.setData(list);
//        return data;
//    }
...
//    public ResponseData years(HttpServletRequest request, HttpServletResponse response) {
//        ResponseData data = new ResponseData();
//
//        int end = NumberUtils.toInt(DateUtils.dateStr(new Date(), "yyyy"));
//
//        List<Integer> list = new ArrayList<>();
//        for (int i = end; i >= 1949; i--) {
//            list.add(i);
//        }
//
//        data.setData(list);
