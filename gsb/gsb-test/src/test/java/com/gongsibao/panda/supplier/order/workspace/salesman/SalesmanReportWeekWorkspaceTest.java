...
/*周统计*/
public class SalesmanReportWeekWorkspaceTest extends WorkspaceCreationBase {
    @Before
    public void setup() {
        super.setup ();
        entity = SoOrder.class;
        urlList = "/crm/order/salesman/week/report";
        listPartName = formPartName = "周统计";
        meta = MtableManager.getMtable (entity);
        formPartName = listPartName = meta.getName ();
        resourceNodeCode = "Gsb_Supplier_Order_Salesman_Week_Report";
        listToolbarPath = "crm/order/orderweekreport/edit";
