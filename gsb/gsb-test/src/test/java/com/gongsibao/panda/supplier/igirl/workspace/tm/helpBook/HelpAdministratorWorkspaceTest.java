...
public class HelpAdministratorWorkspaceTest extends WorkspaceCreationBase{
	@Before
	public void setup() {

		entity = HelpBook.class;
		urlList = "/igirl/help_administrator/list";
		//		partName = "帮助手册";
		//		workspaceName = "帮助手册";
		resourceNodeCode = "IGRIL_ABOUT_ADMINISTRATOR";
	}
	...
	protected void createListWorkspace() {
		...
		PWorkspace workspace = new PWorkspace();
		{
			...
			workspace.setRedirectUrl("/nav/gsb/igirl/help/book/administrator");
