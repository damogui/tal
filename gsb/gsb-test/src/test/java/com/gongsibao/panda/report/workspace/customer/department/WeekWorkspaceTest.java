...
public class WeekWorkspaceTest extends WorkspaceCreationBase {
	...
	@Before
	public void setup() {
		entity =CustomerWeekGrowView.class;
		urlList = "/report/grow/customer/week";
		listPartName = formPartName = "周增长量统计";
		meta = MtableManager.getMtable(entity);
		formPartName = listPartName = meta.getName();
		resourceNodeCode = "GSB_Report_Customer_Grow_Week";
	...
	protected PDatagrid createDatagrid(ResourceNode node) {
		...
		column = addColumn(datagrid, "weeks", "周", ControlTypes.TEXT_BOX, 100, true);
