...
//        addColumn(datagrid, "sjgj",   "sjgj", ControlTypes.TEXT_BOX, 100);
    ...
    protected PForm createForm(ResourceNode node) {
        ...
        addFormField(form, "code", "企业代码", null, ControlTypes.TEXT_BOX, true,false).setWidth(200);
        addFormField(form, "name", "企业名称", null, ControlTypes.TEXT_BOX, true,false).setWidth(200);
        addFormField(form, "arnCode", "信用代码", null, ControlTypes.TEXT_BOX, true,false).setWidth(200);
        addFormField(form, "specialCode", "特行代码", null, ControlTypes.TEXT_BOX, true,false).setWidth(200);
        addFormField(form, "address", "经营地址", null, ControlTypes.TEXT_BOX, true,false).setWidth(200);
        addFormField(form, "operationContent", "经营范围", null, ControlTypes.TEXT_BOX, true,false).setWidth(200);
        addFormField(form, "tel", "联系电话", null, ControlTypes.TEXT_BOX, true,false).setWidth(200);
        addFormField(form, "fax", "传真", null, ControlTypes.TEXT_BOX, true,false).setWidth(200);
        addFormField(form, "email", "email", null, ControlTypes.TEXT_BOX, true,false).setWidth(200);
        addFormField(form, "registeredCapital", "注册资本", null, ControlTypes.TEXT_BOX, true,false).setWidth(200);
        addFormField(form, "setUpTime", "设立时间", null, ControlTypes.TEXT_BOX, true,false).setWidth(200);
        addFormField(form, "secureMan", "安全员", null, ControlTypes.TEXT_BOX, true,false).setWidth(200);
        addFormField(form, "policeMan", "民警", null, ControlTypes.TEXT_BOX, true,false).setWidth(200);
        addFormField(form, "operationArea", "经营面积", null, ControlTypes.TEXT_BOX, true,false).setWidth(200);
        addFormField(form, "artificialPersonName", "紧急联系人", null, ControlTypes.TEXT_BOX, true,false).setWidth(200);
        addFormField(form, "artificialPersionMobile", "紧急联系人手机", null, ControlTypes.TEXT_BOX, true,false).setWidth(200);
        addFormField(form, "artificialPersionIdcard", "紧急联系人身份证号", null, ControlTypes.TEXT_BOX, true,false).setWidth(200);
        addFormField(form, "artificialPersionAddress", "紧急联系人住址", null, ControlTypes.TEXT_BOX, true,false).setWidth(200);
        addFormField(form, "artificialPersionCertType", "紧急联系人确认状态", null, ControlTypes.TEXT_BOX, true,false).setWidth(200);
        addFormField(form, "area", "地区ID", null, ControlTypes.TEXT_BOX, true,false).setWidth(200);
        addFormField(form, "sid", "原数据ID", null, ControlTypes.TEXT_BOX, true,false).setWidth(200);
        addFormField(form, "policeCode", "原policeCode", null, ControlTypes.TEXT_BOX, true,false).setWidth(200);
        addFormField(form, "user", "原user", null, ControlTypes.TEXT_BOX, true,false).setWidth(200);
        addFormField(form, "policeStation", "原policeStation", null, ControlTypes.TEXT_BOX, true,false).setWidth(200);
        addFormField(form, "factoryStatus", "原factoryStatus", null, ControlTypes.TEXT_BOX, true,false).setWidth(200);
