...
public class OrderStatisticsMonthWorkspaceTest extends WorkspaceCreationBase{
	
	@Before
	public void setup() {

		super.setup();
		urlList = "/prod/month/statistics";

		entity = OrderStatisticsDTO.class;
		meta = MtableManager.getMtable(entity);
		resourceNodeCode = "GSB_Product_Manage_statisticsMonth";
