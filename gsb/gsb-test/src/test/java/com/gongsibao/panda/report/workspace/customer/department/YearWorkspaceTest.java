...
public class YearWorkspaceTest extends WorkspaceCreationBase {
	...
	@Before
	public void setup() {
		entity =CustomerYearGrowView.class;
		urlList = "/report/grow/customer/year";
		listPartName = formPartName = "年增长量统计";
		meta = MtableManager.getMtable(entity);
		formPartName = listPartName = meta.getName();
		resourceNodeCode = "GSB_Report_Customer_Grow_Year";
	...
	protected PDatagrid createDatagrid(ResourceNode node) {
		...
		column = addColumn(datagrid, "years", "年份", ControlTypes.TEXT_BOX, 100, true);
