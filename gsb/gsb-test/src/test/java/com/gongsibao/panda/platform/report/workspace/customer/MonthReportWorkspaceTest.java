...
import com.gongsibao.report.web.dataReport.CustomerMonthReportPart;

public class MonthReportWorkspaceTest extends WorkspaceCreationBase{
	...
	public void setup() {
		...
		urlList = "/report/customer/month";
		listPartName = formPartName = "月统计";
		meta = MtableManager.getMtable(entity);
		formPartName = listPartName = meta.getName();
		resourceNodeCode = "GSB_Report_Customer_Moth";
		listPartType = PartType.TREEGRID_PART.getId();
		listPartServiceController = CustomerMonthReportPart.class.getName();
	}
	...
	protected PDatagrid createDatagrid(ResourceNode node) {
		...
		column = addColumn(datagrid, "month", "月份", ControlTypes.TEXT_BOX, 80);{
