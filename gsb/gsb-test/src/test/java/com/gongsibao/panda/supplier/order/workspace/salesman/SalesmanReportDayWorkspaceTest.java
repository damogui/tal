...
/*日统计*/
public class SalesmanReportDayWorkspaceTest extends WorkspaceCreationBase {
    @Before
    public void setup() {
        super.setup ();
        entity = SoOrder.class;
        urlList ="/crm/order/salesman/day/report";
        listPartName = formPartName = "日统计";
        meta = MtableManager.getMtable (entity);
        formPartName = listPartName = meta.getName ();
        resourceNodeCode = "Gsb_Supplier_Order_Salesman_Day_Report";
        listToolbarPath = "crm/order/orderdayreport/edit";
