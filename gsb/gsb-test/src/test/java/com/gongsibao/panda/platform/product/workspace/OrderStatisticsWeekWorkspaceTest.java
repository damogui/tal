...
public class OrderStatisticsWeekWorkspaceTest extends WorkspaceCreationBase{
	
	@Before
	public void setup() {

		super.setup();
		urlList = "/prod/week/statistics";

		entity = OrderStatisticsDTO.class;
		meta = MtableManager.getMtable(entity);
		resourceNodeCode = "GSB_Product_Manage_statisticsWeek";
	...
	protected PDatagrid createDatagrid(ResourceNode node) {
		...
		addColumn(datagrid, "month", "月份", ControlTypes.TEXT_BOX, 100);
		addColumn(datagrid, "week", "周", ControlTypes.TEXT_BOX, 100);
		addColumn(datagrid, "count", "销售数量", ControlTypes.TEXT_BOX, 100);
		addColumn(datagrid, "price", "总额", ControlTypes.TEXT_BOX, 200);
		addColumn(datagrid, "weekDay", "周期", ControlTypes.TEXT_BOX, 200);
		return datagrid;
	}
