...
public class SalesmanOrderInvoiceWorkspaceTest extends WorkspaceCreationBase {
    ...
    protected PDatagrid createDatagrid(ResourceNode node) {
        ...
        addColumn(datagrid, "soOrder.totalPrice", "订单金额", ControlTypes.DECIMAL_FEN_BOX, 100);
        addColumn(datagrid, "soOrder.payablePrice", "付款金额", ControlTypes.DECIMAL_FEN_BOX, 100);
