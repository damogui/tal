...
public class ResourceTest extends ResourceCreationBase {
	...
	protected void createResourceNodeVouchers(ResourceNode node) {
		...
		node1 = this.createResourceNodeCategory("金牛座", "GSB_TAURUS", node.getId());
		{
			...
			this.createResourceNodeVoucher(UserCollectCompany.class.getName(), "关注企业", "GSB_TAURUS_" + UserCollectCompany.class.getSimpleName(), IUserCollectCompanyService.class.getName(),
					node1.getId());
			this.createResourceNodeVoucher(UserDingtalkKeyword.class.getName(), "舆情关键字", "GSB_TAURUS_" + UserDingtalkKeyword.class.getSimpleName(), IUserDingtalkKeywordService.class.getName(),
					node1.getId());
			this.createResourceNodeVoucher(NewUserPerDayView.class.getName(), "每日新增用户数", "GSB_TAURUS_" + NewUserPerDayView.class.getSimpleName(), INewUserPerDayViewService.class.getName(),
					node1.getId());
			this.createResourceNodeVoucher(UserConsStatisticView.class.getName(), "用户消费统计", "GSB_TAURUS_" + UserConsStatisticView.class.getSimpleName(), IUserConsStatisticViewService.class.getName(),
					node1.getId());
			this.createResourceNodeVoucher(UserRenewalStatisticView.class.getName(), "用户续费统计", "GSB_TAURUS_" + UserRenewalStatisticView.class.getSimpleName(),
					IUserRenewalStatisticViewService.class.getName(), node1.getId());
			...
			this.createResourceNodeVoucher(JnzUserBehaviorStatistics.class.getName(), "统计数据", "GSB_TAURUS_" + JnzUserBehaviorStatistics.class.getSimpleName(),
					IBdUserBehaviorStatistics.class.getName(), node1.getId());
			this.createResourceNodeVoucher(UserConsumptionView.class.getName(), "用户消费数据", "GSB_TAURUS_" + UserConsumptionView.class.getSimpleName(), IUserConsumptionService.class.getName(),
					node1.getId());
			this.createResourceNodeVoucher(UcOrganizationUserView.class.getName(), "业务用户统计", "GSB_TAURUS_" + UcOrganizationUserView.class.getSimpleName(), IUcOrganizationService.class.getName(),
					node1.getId());
		}
		...
		{
			this.createResourceNodeVoucher(SupplierCategory.class.getName(), "服务商分组", "GSB_Operation_Supplier_Category", ISupplierCategoryService.class.getName(), node1.getId());
			...
			this.createResourceNodeVoucher(SupplierCategoryOwnerMap.class.getName(), "部门服务范围", "GSB_Operation_Supplier_CategoryOwnerMap", ISupplierCategoryOwnerMapService.class.getName(),
					node1.getId());

		}
		// node1 = this.createResourceNodeCategory("客户管理（旧）", "GSB_CRM_Manager",
		// node.getId());
		// {
		// this.createResourceNodeVoucher(Customer.class.getName(), "全部客户",
		// "CRM_All_" + Customer.class.getSimpleName(),
		// ICustomerService.class.getName(), node1.getId());
		// this.createResourceNodeVoucher(SoOrder.class.getName(), "客户订单",
		// "CRM_My_All_" + SoOrder.class.getSimpleName(),
		// IOrderService.class.getName(), node1.getId());
		// this.createResourceNodeVoucher(Customer.class.getName(), "我的客户",
		// "CRM_My_" + Customer.class.getSimpleName(),
		// ICustomerService.class.getName(), node1.getId());
		// this.createResourceNodeVoucher(Customer.class.getName(), "客户池",
		// "CRM_Pool_" + Customer.class.getSimpleName(),
		// ICustomerService.class.getName(), node1.getId());
		// this.createResourceNodeVoucher(Customer.class.getName(), "客户操作",
		// "CRM_Operation_" + Customer.class.getSimpleName(),
		// ICustomerService.class.getName(), node1.getId());
		// this.createResourceNodeVoucher(Dict.class.getName(), "城市",
		// Dict.class.getSimpleName(), IPersistableService.class.getName(),
		// node1.getId());
		// this.createResourceNodeVoucher(CustomerProdMap.class.getName(),
		// "意向产品", CustomerProdMap.class.getSimpleName(),
		// ICustomerProdMapService.class.getName(), node1.getId());
		// this.createResourceNodeVoucher(Product.class.getName(), "产品", "CRM_"
		// + Product.class.getSimpleName(), IPersistableService.class.getName(),
		// node1.getId());
		//
		// this.createResourceNodeVoucher(CompanyIntention.class.getName(),
		// "企业信息", "CRM_" + CompanyIntention.class.getSimpleName(),
		// ICompanyIntentionService.class.getName(), node1.getId());
		// this.createResourceNodeVoucher(CustomerCompanyMap.class.getName(),
		// "关联企业", CustomerCompanyMap.class.getSimpleName(),
		// ICustomerCompanyMapService.class.getName(), node1.getId());
		// this.createResourceNodeVoucher(CustomerFollow.class.getName(),
		// "沟通日志", CustomerFollow.class.getSimpleName(),
		// ICustomerFollowService.class.getName(), node1.getId());
		// this.createResourceNodeVoucher(SoOrder.class.getName(), "订单记录",
		// SoOrder.class.getSimpleName(), IPersistableService.class.getName(),
		// node1.getId());
		//
		// this.createResourceNodeVoucher(CustomerOrder.class.getName(), "订单列表",
		// "CRM_" + CustomerOrder.class.getSimpleName(),
		// ICustomerOrderService.class.getName(), node1.getId());
		// }
		...
		node1 = this.createResourceNodeCategory("客户管理", "Operation_CRM", node.getId());
		{
			...
			this.createResourceNodeVoucher(NCustomerTask.class.getName(), "新增商机", "Operation_CRM_Task_Add", INCustomerTaskService.class.getName(), node1.getId());
			this.createResourceNodeVoucher(NCustomerTask.class.getName(), "修改商机", "Operation_CRM_Task_Edit", INCustomerTaskService.class.getName(), node1.getId());
			...
			this.createResourceNodeVoucher(NCustomerTask.class.getName(), "未分配商机", "Operation_CRM_Task_Undistributed", INCustomerTaskService.class.getName(), node1.getId());
			this.createResourceNodeVoucher(NCustomerTask.class.getName(), "未启动商机", "Operation_CRM_Task_UNstart", INCustomerTaskService.class.getName(), node1.getId());
			...
			// this.createResourceNodeVoucher(Customer.class.getName(), "企业信息库",
			// "CRM_Enterprise", ICustomerService.class.getName(),
			// node1.getId());
			this.createResourceNodeVoucher(Product.class.getName(), "产品", "CRM_Product", IPersistableService.class.getName(), node1.getId());
		...
		node1 = this.createResourceNodeCategory("智能商标", "Operation_IGIRL", node.getId());
		{
			...
			this.createResourceNodeVoucher(UploadAttachment.class.getName(), "上传附件", "Operation_IGIRL_UPLOAD_" + UploadAttachment.class.getSimpleName(), IUploadAttachmentService.class.getName(),
					node1.getId());
			this.createResourceNodeVoucher(DownloadAttachment.class.getName(), "下载附件", "Operation_IGIRL_DOWNLOAD_" + DownloadAttachment.class.getSimpleName(),
					IDownloadAttachmentService.class.getName(), node1.getId());
		}
