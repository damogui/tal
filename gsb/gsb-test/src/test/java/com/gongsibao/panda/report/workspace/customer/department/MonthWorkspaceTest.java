...
public class MonthWorkspaceTest extends WorkspaceCreationBase {
	...
	@Before
	public void setup() {
		entity =CustomerMonthGrowView.class;
		urlList = "/report/grow/customer/month";
		listPartName = formPartName = "月增长量统计";
		meta = MtableManager.getMtable(entity);
		formPartName = listPartName = meta.getName();
		resourceNodeCode = "GSB_Report_Customer_Grow_Month";
	...
	protected PDatagrid createDatagrid(ResourceNode node) {
		...
		column = addColumn(datagrid, "months", "月份", ControlTypes.TEXT_BOX, 100, true);
