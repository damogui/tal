...
import com.gongsibao.supplier.service.FunctionModuleRoleService;
import com.gongsibao.supplier.service.FunctionModuleService;
...
import org.netsharp.organization.service.RoleGroupService;
import org.netsharp.organization.service.RoleService;
...
/**
 * Created by win on 2018/1/25.
 * 预设角色(sys_permission_role  Role)和功能(sp_function_module)表
 */
public class ImportTaskRoleAndFunctionTest {
    ...
    IFunctionModuleRoleService serviceFunctionModuleRoleService = ServiceFactory.create(IFunctionModuleRoleService
            .class);//功能角色明细
    ...
    public void run() {
        ...
        String sqlFunctionModuleRole = "SELECT  id FROM  sp_function_module_role   WHERE function_module_id=?  and " +
                "role_id=?;";
