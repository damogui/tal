...
public class HelpCustomerWorkspaceTest extends WorkspaceCreationBase{
	@Before
	public void setup() {

		entity = HelpBook.class;
		urlList = "/igirl/help_customer/list";
		//		partName = "帮助手册";
		//		workspaceName = "帮助手册";
		resourceNodeCode = "IGRIL_ABOUT_CUSTOMER";
	}
	...
	protected void createListWorkspace() {
		...
		PWorkspace workspace = new PWorkspace();
		{
			...
			workspace.setRedirectUrl("/nav/gsb/igirl/help/book/customer");
