...
public class ResourceTest extends ResourceCreationBase {
    ...
    protected void createResourceNodeVouchers(ResourceNode node) {
        ...
        node1 = this.createResourceNodeCategory("U8配置", prefix + "_U8", node.getId());
        {
            ...
            this.createResourceNodeVoucher(U8Department.class.getName(), "部门编码管理", node1.getCode() + "_" + U8Department.class.getSimpleName(), IU8DepartmentService.class.getName(), node1.getId());
