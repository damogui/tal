package com.gongsibao.panda.operation.workspace.crm.old;
...
public class CustomerAllWorkspaceTest extends WorkspaceCreationBase {
    ...
    public void setup() {
        ...
        formJsImport = "/gsb/platform/operation/crm/js/old/customer.form.part.js|/gsb/panda-extend/gsb.customer.controls.js";
    ...
    protected PDatagrid createDatagrid(ResourceNode node) {
        ...
        column = addColumn(datagrid, "accountId", "是否会员", ControlTypes.BOOLCOMBO_BOX, 100);
        {
            column.setFormatter("return value&&value!=0?'是':'否';");
        }
