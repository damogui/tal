...
public class NavigationTest extends NavigationBase {
	...
	protected void doCreateTree(PNavigation tree) {
		...
		createPTreeNode(tree, null, "fa fa-file-o fa-fw", "GSB_Basic_Dict", "字典管理", "", 1);
		{
			createPTreeNode(tree, "GSB_Basic_Dict", null, "GSB_Basic_Dict_" + Dict.class.getSimpleName(), "字典管理", "/basic/dict/manage/list", 1);
		}
		...
		createPTreeNode(tree, null, "fa fa-file-o fa-fw", "GSB_Basic_U8", "U8配置", "", 1);// 一级菜单
		{
			...
			// createPTreeNode(tree, "GSB_Basic_U8", null, "GSB_Basic_U8_" +
			// ReceivablesAuditDTO.class.getSimpleName(), "收款审核列表",
			// "/basic/u8/receivablesaudit/list", 3);//二级菜单
		}
	}
}