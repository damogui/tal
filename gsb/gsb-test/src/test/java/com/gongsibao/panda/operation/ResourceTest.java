...
public class ResourceTest extends ResourceCreationBase {
	...
	protected void createResourceNodeVouchers(ResourceNode node) {
		...
		node1 = this.createResourceNodeCategory("服务商管理", "GSB_Supplier", node.getId());
		{
			...
			this.createResourceNodeVoucher(SupplierServiceDistrict.class.getName(), "服务商服务地区", "GSB_Operation_Supplier_Service_District", ISupplierServiceDistrictService.class.getName(),
					node1.getId());
