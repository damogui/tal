...
public class ResourceTest extends ResourceCreationBase {
	...
	protected void createResourceNodeVouchers(ResourceNode node) {
		...
		node1 = this.createResourceNodeCategory("万达项目", "GSB_WANDA", node.getId());
		{
			...
			this.createResourceNodeVoucher(SoOrder.class.getName(), "订单查询", "GSB_WANDA_" + SoOrder.class.getSimpleName(), IOrderService.class.getName(), node1.getId());
		}
		//
		// node1 = this.createResourceNodeCategory("ICompany", "GSB_WANDA",
		// node.getId());
		// {
		// this.createResourceNodeVoucher(ProductView.class.getName(), "服务列表",
		// "GSB_WANDA" +
		// ProductView.class.getSimpleName(),IProductViewService.class.getName(),
		// node1.getId());
		// }
		//
		// node1 = this.createResourceNodeCategory("供应商管理", "GSB_WANDA",
		// node.getId());
		// {
		// this.createResourceNodeVoucher(ProductView.class.getName(), "服务列表",
		// "GSB_WANDA" +
		...
		// }
		//
		// node1 = this.createResourceNodeCategory("网站CMS", "GSB_WANDA",
		// node.getId());
		// {
		// this.createResourceNodeVoucher(ProductView.class.getName(), "服务列表",
		// "GSB_WANDA" +
