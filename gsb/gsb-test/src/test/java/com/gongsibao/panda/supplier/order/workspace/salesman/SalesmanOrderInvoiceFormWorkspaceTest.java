...
public class SalesmanOrderInvoiceFormWorkspaceTest extends WorkspaceCreationBase {
    ...
    protected PForm createForm(ResourceNode node) {
        ...
        addFormField(form, "receiverName", "发票接收人", groupName, ControlTypes.TEXT_BOX, false, false);
        addFormField(form, "receiverMobilePhone", "手机", groupName, ControlTypes.TEXT_BOX, false, false);
        addFormField(form, "receiverEmail", "邮箱", groupName, ControlTypes.TEXT_BOX, false, false);
        addFormField(form, "receiverAddress", "邮寄地址", groupName, ControlTypes.TEXT_BOX, false, false);
