package com.gongsibao.panda.platform.franchisee.workspace.my;
...
public class MyFranchiseeWorkspaceTest  extends WorkspaceCreationBase{
	...
	public void setup() {
		...
		formJsImport = "/gsb/platform/franchisee/js/franchisee.form.part.js";
		...
		listPartImportJs = "/gsb/platform/franchisee/js/franchisee.list.part.js";
	...
	protected PDatagrid createDatagrid(ResourceNode node) {
		...
		column = addColumn(datagrid, "lastTracker.name", "最后跟进人", ControlTypes.TEXT_BOX, 100);{
			column.setGroupName(groupName);
		}
	...
	protected PForm createForm(ResourceNode node) {
		...
		formField = addFormField(form, "city.name", "城市",groupName,ControlTypes.PCC_BOX, false, false);{
