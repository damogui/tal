...
public class ResourceTest extends ResourceCreationBase {
	...
	protected void createResourceNodeVouchers(ResourceNode node) {
		...
		node1 = this.createResourceNodeCategory("部门管理", "GSB_BD_DEPARTMENT", node.getId());
		{
			...
			this.createResourceNodeVoucher(Franchisee.class.getName(), "未跟进", "BD_DEPARTMENT_Franchisee_UnTrack", IFranchiseeService.class.getName(), node1.getId());
		...
		node1 = this.createResourceNodeCategory("运营管理", "GSB_BD_OPERATION", node.getId());
		{
			...
			this.createResourceNodeVoucher(Franchisee.class.getName(), "未跟进", "GSB_BD_OPERATION_UnTrack", IFranchiseeService.class.getName(), node1.getId());
