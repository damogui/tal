...
import com.gongsibao.igirl.web.DepartmentTransferTradeMarkListPart;
import com.gongsibao.igirl.web.TransferTradeMarkListPart;
...
public class DpTransferTradeMarkFollowWorkspaceTest extends WorkspaceCreationBase{

	@Before
	public void setup() {
		urlList = "/igirl/dpttm/progress/list";
		urlForm = "/igirl/dpttm/progress/form";
		entity = TransferTradeMark.class;
		meta = MtableManager.getMtable(entity);
		resourceNodeCode = "IGIRL_Dp_TransferTradeMark";
		formPartName = listPartName = meta.getName();
		formOpenMode = OpenMode.WINDOW;
		openWindowWidth = 800;
		openWindowHeight = 600;
		listToolbarPath="/igirl/dpttm/transferTradeMark/list";
		listPartServiceController = DepartmentTransferTradeMarkListPart.class.getName();
