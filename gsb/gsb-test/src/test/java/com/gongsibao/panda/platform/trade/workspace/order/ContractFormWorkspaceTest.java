...
public class ContractFormWorkspaceTest extends WorkspaceCreationBase {
	...
	public void setup() {
		...
		formJsImport = "/gsb/platform/trade/js/contract-add-form.part.js|/package/qiniu/plupload.full.min.js";
	...
	protected PForm createForm(ResourceNode node) {
		...
		formField = addFormField(form, "electronics", "合同类型", groupName, ControlTypes.ENUM_BOX, false, false);
		{
			formField.setTroikaTrigger("controllercontract.contractTypeChange(this);");
		}
		formField = addFormField(form, "contractType", "客户类型", groupName, ControlTypes.ENUM_BOX, false, false);
		{
			formField.setTroikaTrigger("controllercontract.customerTypeChange(this);");
		}
		addFormField(form, "businessLicenseNo", "营业执照号", groupName, ControlTypes.TEXT_BOX, true, false);
		addFormField(form, "idNumber", "身份证号", groupName, ControlTypes.TEXT_BOX, true, false);
