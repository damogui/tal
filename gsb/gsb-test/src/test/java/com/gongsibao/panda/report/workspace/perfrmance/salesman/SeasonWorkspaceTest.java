...
public class SeasonWorkspaceTest extends WorkspaceCreationBase {
	...
	public void setup() {
		...
		urlList = "/report/perfrmance/salesman/season";
		listPartName = formPartName = "业务员季统计";
		meta = MtableManager.getMtable(entity);
		formPartName = listPartName = meta.getName();
		resourceNodeCode = "GSB_Report_Salesman_Perfrmance_Season";
	...
	protected PQueryProject createQueryProject(ResourceNode node) {
		...
		item = addQueryItem(queryProject, "salesman.name", "业务员", ControlTypes.TEXT_BOX);
		{
