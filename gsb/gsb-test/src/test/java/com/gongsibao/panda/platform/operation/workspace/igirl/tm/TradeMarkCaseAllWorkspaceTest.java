...
import com.gongsibao.igirl.tm.web.TradeMarkCaseListPart;
import com.gongsibao.igirl.tm.web.TradeMarkCaseOptListPart;
...
public class TradeMarkCaseAllWorkspaceTest extends WorkspaceCreationBase {
	...
	public void setup() {
		...
		urlList = "/operation/igirl/trademarkcase/all/list";
		urlForm = "/operation/igirl/trademarkcase/all/form";
		...
		listToolbarPath = "/operation/igirl/list/toolbar";
		
		listPartImportJs="/gsb/igirl/js/markcase.list.part.js";
    listPartJsController=TradeMarkCaseListPart.class.getName();
	}
	public static final String trademarkToolbarPath = "/operation/igirl/tm/toolbar";
	public static final String uploadloadToolbarPath = "/operation/igirl/upload/toolbar";
	public static final String downloadToolbarPath = "/operation/igirl/download/toolbar";
	...
	public void fromToolbar() {
		...
		node = this.resourceService.byCode("Operation_IGIRL_UPLOAD_UploadAttachment");
		...
		node = this.resourceService.byCode("Operation_IGIRL_DOWNLOAD_DownloadAttachment");
		ot1 = operationTypeService.byCode(OperationTypes.add);
		toolbar = new PToolbar();
		{
			toolbar.toNew();
		...
		node = this.resourceService.byCode("Operation_IGIRL_All_TradeMark");
		ot1 = operationTypeService.byCode(OperationTypes.add);
		toolbar = new PToolbar();
		{
			toolbar.toNew();
