...
public class NavigationTest extends NavigationBase {
	...
	protected void doCreateTree(PNavigation tree) {
		...
		createPTreeNode(tree, null, null, "GSB_BD_DEPARTMENT", "部门管理", "", 2);
		{
			...
			createPTreeNode(tree, "GSB_BD_DEPARTMENT", null, "BD_DEPARTMENT_Franchisee_UnTrack", "未跟进", "/bd/department/franchisee/untrack/list", 2);
			createPTreeNode(tree, "GSB_BD_DEPARTMENT", null, "BD_DEPARTMENT_Franchisee_Track", "跟进列表", "/bd/department/franchisee/track/list", 3);
			createPTreeNode(tree, "GSB_BD_DEPARTMENT", null, "BD_DEPARTMENT_Franchisee_Track_Report", "跟进记录", "/bd/department/track/report", 4);
		...
		createPTreeNode(tree, null, null, "GSB_BD_OPERATION", "运营管理", "", 3);
		{
			...
			createPTreeNode(tree, "GSB_BD_OPERATION", null, "GSB_BD_OPERATION_UnTrack", "未跟进", "/bd/operation/franchisee/untrack/list", 2);
			createPTreeNode(tree, "GSB_BD_OPERATION", null, "GSB_BD_OPERATION_Track", "跟进记录", "/bd/operation/franchisee/track/list", 3);
