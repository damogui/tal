...
public class ReceiptAuditWorkspaceTest extends WorkspaceCreationBase {
	...
	protected PDatagrid createDatagrid(ResourceNode node) {
		...
		addColumn(datagrid, "pay.orderPayMaps.soOrder.payStatus.name", "订单支付状态", ControlTypes.ENUM_BOX, 80);
		addColumn(datagrid, "pay.orderPayMaps.soOrder.processStatus.name", "订单办理状态", ControlTypes.ENUM_BOX, 80);
