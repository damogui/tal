...
public class HelpManagerWorkspaceTest extends WorkspaceCreationBase{
	@Before
	public void setup() {

		entity = HelpBook.class;
		urlList = "/igirl/help_manager/list";
		//		partName = "帮助手册";
		//		workspaceName = "帮助手册";
		resourceNodeCode = "IGRIL_ABOUT_MANAGER";
	}
	...
	protected void createListWorkspace() {
		...
		PWorkspace workspace = new PWorkspace();
		{
			...
			workspace.setRedirectUrl("/nav/gsb/igirl/help/book/manager");
