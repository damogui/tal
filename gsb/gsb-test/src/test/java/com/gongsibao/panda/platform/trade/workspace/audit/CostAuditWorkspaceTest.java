...
public class CostAuditWorkspaceTest extends WorkspaceCreationBase{
	@Before
	public void setup() {

		entity = AuditLog.class;// 实体
		urlList = "/trade/audit/cost/list";// 列表的url
		urlForm = "/trade/audit/cost/form";// 弹出框的url
		listPartName = formPartName = "改价审核列表";
		meta = MtableManager.getMtable(entity);// 获取实体元数据
		formPartName = listPartName = meta.getName();
		resourceNodeCode = "GSB_Trade_Audit_Cost";// 菜单节点码（名称）
