...
public class Action5RefreshtOrder extends AbstractActionService {
    ...
    public void run() {
        ...
        //跟新审核记录的max_level的值
        cmdText = "UPDATE bd_audit_log l,(SELECT type_id,form_id,MAX(bd_audit_log.level)'maxLevel' FROM bd_audit_log GROUP BY type_id,form_id) l2 SET l.max_level = l2.maxLevel WHERE l.type_id = l2.type_id AND l.form_id = l2.form_id;";
        dao.executeInsert(cmdText, null);
