...
if(opts.buttonText||opts.buttonIcon){
	var buttonId = "button_"+_4f6.id;
var btn=$("<a href=\"javascript:;\" class=\"textbox-button\"></a>").prependTo(tb);
btn.addClass("textbox-button-"+opts.buttonAlign).linkbutton({id:buttonId,text:opts.buttonText,iconCls:opts.buttonIcon,onClick:function(){
...
$.fn.filebox.defaults=$.extend({},$.fn.textbox.defaults,{buttonIcon:"fa fa-cloud-upload",buttonText:"",buttonAlign:"right",inputEvents:{},accept:"",capture:"",separator:",",multiple:false});
})(jQuery);
(function($){
function _571(_572){
...
$.fn.combogrid.defaults=$.extend({},$.fn.combo.defaults,$.fn.datagrid.defaults,{loadMsg:null,idField:null,textField:null,unselectedValues:[],mappingRows:[],mode:"local",
