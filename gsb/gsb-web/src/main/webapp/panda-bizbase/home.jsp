		...
		<div class="media account-info">
            ...
            <div class="media-body">
                ...
                <p>
                    ...
                    <a href="javascript:window.top.workbench.openWorkspace('操作日志','/panda/system/nlog/list?creatorId=<%=employee.getId()%>',null, true,'1',null,null,null);">日志</a>，如果不是您本人登录，请及时  <a href="javascript:window.top.workbench.changePassword();">修改密码</a>。
                </p>
            </div>
        </div>
         <!-- 
