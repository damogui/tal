    ...
    open: function (taskId, customerId, originalQualityId, callback) {
        ...
        PandaHelper.openDynamicForm({
            ...
            callback: function (index, layero) {
                ...
                var returnedAmount = System.RMB.yuanToFen($("#returnedAmount").numberbox('getValue'));

                var signingAmount = System.RMB.yuanToFen($("#signingAmount").numberbox('getValue'));
