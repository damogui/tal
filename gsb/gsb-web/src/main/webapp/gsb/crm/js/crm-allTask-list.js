	...
	backTaskPopup : function() {
		...
		layer.open({
			...
			btn1 : function(index, layero) {
				...
				me.operatBackTaskPopup(taskId,salesmanId,getNote);
			},
			btn2 : function(index, layero) {
			}
		});
	},operatBackTaskPopup : function(taskId,salesmanId,getNote) {
		var me = this;
		this.invokeService("operatBackTask", [taskId,salesmanId,getNote],function(data) {
			alert(123);
			me.reload();
