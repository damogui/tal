...
<div class="easyui-panel" title="订单信息" style="height:70px;padding-left:10px;" data-options="tools:[{
    ...
    <p class="orderProd">订单号：<span id="orderNo"></span> 订单明细：<span id="orderProdNo"></span> 公司：<span
            id="companyName"></span> 办理名称：<span id="handleName"></span> 申请号：<span id="applyNo"></span></p>
</div>
        ...
        <div class="easyui-panel" style="height:209px;border-top-width: 0px;border-bottom-width: 0px;">
            ...
            <div class="toolbar" style="border-bottom: 1px solid #eee;border-top-width:0px;background-color: #fff;">
                <table cellspacing="0" cellpadding="0">
                    <tr>
                        <td>
                            <a id="btn_processStatus" href="javascript:traceCtrl.updateProcessStatus();"
                               class="easyui-linkbutton" data-options="plain:true,iconCls:'fa fa-refresh'">更改状态</a>
                        </td>
                        <td>
                            <div class="datagrid-btn-separator"></div>
                        </td>
                        <td>
                            <a id="btn_remark" href="javascript:traceCtrl.remark();" class="easyui-linkbutton"
                               data-options="plain:true,iconCls:'fa fa-edit'">备注</a>
                        </td>
                        <td>
                            <div class="datagrid-btn-separator"></div>
                        </td>
                        <td>
                            <a id="btn_upload" href="javascript:fileCtrl.openUploadWindow();" class="easyui-linkbutton"
                               data-options="plain:true,iconCls:'fa fa-cloud-upload'">上传</a>
                        </td>
                        ...
                        <td>
                            <a id="btn3" href="javascript:traceCtrl.markComplaint();" class="easyui-linkbutton"
                               data-options="plain:true,iconCls:'fa fa-paint-brush'">标记投诉</a>
                        </td>
                        <td>
                            <div class="datagrid-btn-separator"></div>
                        </td>
                        <td>
                            <a id="btn4" href="javascript:traceCtrl.remindCustomer();" class="easyui-linkbutton"
                               data-options="plain:true,iconCls:'fa fa-meh-o'">提示客户</a>
                        </td>
                        <td>
                            <div class="datagrid-btn-separator"></div>
                        </td>
                        <td>
                            <a id="btn5" href="javascript:traceCtrl.markAbnormal();" class="easyui-linkbutton"
                               data-options="plain:true,iconCls:'fa fa-fire'">标记异常</a>
                        </td>
                        <td>
                            <div class="datagrid-btn-separator"></div>
                        </td>
                        <td>
                            <a id="btn6" href="javascript:traceCtrl.sendExpress();" class="easyui-linkbutton"
                               data-options="plain:true,iconCls:'fa fa-send mr-sm'">发快递</a>
                        </td>
                        <td>
                            <div class="datagrid-btn-separator"></div>
                        </td>
                        <!--<td>
                            <a id="btn7" href="javascript:traceCtrl.setAccount();" class="easyui-linkbutton"
                               data-options="plain:true,iconCls:'fa fa-user-o'">帐号密码</a>
                        </td>
            ...
            <div style="padding-left:30px;height: 162px;background-color: #fff;">
                ...
                <p style="font-size:24px;margin: 10px 0;"><span id="processStatus" style="color:#009688;">0</span> <span
                        id="nodeDayCount">0</span> / <span id="weekdayCount">0</span>天</p>
...
<div id="detail_tabs" class="easyui-tabs" tabHeight="30" style="height:100%;">
    ...
    <div title="企业信息">
        <div class="toolbar"
             style="border-bottom: 1px solid #eee;border-top-width:0px;border-top: 1px solid #eee;background-color: #fff;">
            <a id="btn_add_relevance_company" href="javascript:companyCtrl.addRelevanceCompany();"
               class="easyui-linkbutton" data-options="plain:true,iconCls:'fa fa-plus'">添加关联公司</a>
            <a id="btn_edit_company" href="javascript:companyCtrl.editCompany();" class="easyui-linkbutton"
               data-options="plain:true,iconCls:'fa fa-edit'">编辑公司信息</a>
            <a id="btn_cancel_relevance_company" href="javascript:companyCtrl.cancelRelevanceCompany();"
               class="easyui-linkbutton" data-options="plain:true,iconCls:'fa fa-trash-o'">取消关联<span style="color:red;">(慎用)</span></a>
        </div>
