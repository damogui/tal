...
public class PerfrmanceSalesmanSeasonService extends AbstractPerfrmanceSalesmanService {

	@Override
	public void before() {

		AbstractPerfrmanceService netService = new PerfrmanceSalesmanYearService();
	...
	public void doExecute() {
		...
		{
			builder.select("department_id as departmentId", "salesman_id as salesmanId", "year", "season", "SUM(receivable_amount) as receivableAmount", "SUM(paid_amount) as paidAmount",
