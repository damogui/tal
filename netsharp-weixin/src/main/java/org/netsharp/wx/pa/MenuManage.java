...
import org.netsharp.wx.mp.api.menu.ButtonInfo;
import org.netsharp.wx.mp.api.menu.ButtonType;
import org.netsharp.wx.mp.api.menu.MenuCreateRequest;
import org.netsharp.wx.mp.api.menu.MenuData;
import org.netsharp.wx.mp.api.menu.MenuDeleteRequest;
import org.netsharp.wx.mp.api.menu.SubButton;
import org.netsharp.wx.mp.api.menu.TopButton;
...
public class MenuManage {
	...
	private static Log logger = LogFactory.getLog("weixin." + MenuManage.class.getSimpleName());
    ...
    /*生成微信菜单*/
    public void create(String originalId, List<NMenuItem> tops) throws NetsharpException {
        if (tops.size() > 3) {
    ...
    /*删除微信菜单*/
    public void delete() throws NetsharpException {
        WeixinMessageListener listner = new WeixinMessageListener();
        AccessToken token = listner.getAccessToken(this.originalId);
