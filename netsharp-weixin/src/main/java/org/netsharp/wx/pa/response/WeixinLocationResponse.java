...
public class WeixinLocationResponse implements IWeixinResponsor {
    ...
    protected static Log          logger      = LogFactory.getLog("weixin."+WeixinLocationResponse.class.getSimpleName());
...
//        }
    ...
    @Override
    public ResponseMessage response(RequestMessage request) throws NetsharpException {
        try {
    ...
    public ResponseMessage doResponse(RequestMessage request) throws NetsharpException {
