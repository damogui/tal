...
import org.netsharp.wx.mp.api.oauth.OAuthRequest.OauthScope;
import org.netsharp.wx.mp.api.oauth.OAuthResponse;
import org.netsharp.wx.mp.api.user.UserInfoRequest;
import org.netsharp.wx.mp.api.user.UserInfoResponse;
...
public class FansService extends PersistableService<Fans> implements IFansService {
	...
	private static Log logger = LogFactory.getLog("weixin."+FansService.class.getSimpleName());
	 ...
	 */
	public Fans subscribe(String openId, PublicAccount pa, int sceneId, boolean isSubscribeEvent) throws NetsharpException {
	...
	public Fans unsubscribe(String openid, PublicAccount wcp) throws NetsharpException {
	...
	public Fans byOpenId(String openid) throws NetsharpException {
