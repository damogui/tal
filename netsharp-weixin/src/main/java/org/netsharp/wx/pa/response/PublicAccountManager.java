...
public class PublicAccountManager {
	...
	private static Log logger = LogFactory.getLog("weixin." + PublicAccountManager.class.getSimpleName());
	...
	private void doInitialize(String originalId) {
		...
		try {
			...
			//
			appRelations = new HashMap<String, String>();
