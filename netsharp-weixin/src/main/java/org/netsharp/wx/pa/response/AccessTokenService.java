...
import org.netsharp.wx.mp.api.accesstoken.AccessTokenRequest;
import org.netsharp.wx.mp.api.accesstoken.IAccessTokenService;
import org.netsharp.wx.mp.api.accesstoken.PAccount;
import org.netsharp.wx.mp.api.accesstoken.WeixinCache;
...
public class AccessTokenService implements IAccessTokenService {
	...
	private Log logger = LogFactory.getLog("weixin."+AccessTokenManage.class.getSimpleName());

	public AccessToken getTokenByAppId(String appId) throws NetsharpException {
