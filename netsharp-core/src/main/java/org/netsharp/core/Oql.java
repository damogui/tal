...
public class Oql implements Serializable {
	...
	public String toString() {
		...
		builder.append("entityId : ").append(this.entityId).append(StringManager.NewLine);
		builder.append("selects  : ").append(this.selects).append(StringManager.NewLine);
		builder.append("filter   : ").append(this.filter).append(StringManager.NewLine);
		builder.append("orderby  : ").append(this.orderby).append(StringManager.NewLine);
		builder.append("paging  : ").append(this.paging).append(StringManager.NewLine);
