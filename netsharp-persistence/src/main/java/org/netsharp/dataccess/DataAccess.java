...
public class DataAccess implements IDataAccess {
	...
	private static final Log logger = LogFactory.getLog("dao." + DataAccess.class.getName());
	protected Connection con;
	private DatabaseProperty databaseProperty;

	public DataAccess(DatabaseProperty dbp) {
	...
	protected PreparedStatement prepareStatement(String cmdText, QueryParameters qps) throws DataAccessException {
		...
		logger.debug(StringManager.NewLine + cmdText);
	...
	protected PreparedStatement prepareStatement(String cmdText, QueryParameters qps, int autoGeneratedKeys) throws DataAccessException {
		...
		try {
			...
			if (table == null) {
				...
				for (int i = 1; i <= columnsCount; i++) {
					...
					property.setPropertyName(schema.getColumnName(i));
	...
	public Set executeSet(String cmdText, QueryParameters qps) {
		return null;
	}
