...
public class Persister<T extends IPersistable> implements IPersister<T> {
	...
	public Persister(DatabaseProperty dbp) {

		dao = DataAccessFactory.create(dbp);
	}

	public T byId(T entity) throws NetsharpException {
		return byId(entity, SqlGeneratorType.FullSelect);
	}

	@SuppressWarnings("unchecked")
	public T byId(String entityId, Object id) throws NetsharpException {
	...
	@SuppressWarnings("unchecked")
	public T byId(Class<?> type, Object id) throws NetsharpException {
	...
	public T byId(T entity, SqlGeneratorType operationType) throws NetsharpException {
	...
	public boolean persistNew(T entity) throws NetsharpException {

		if (entity instanceof Entity) {
			Entity sys = (Entity) entity;
	...
	public boolean persistNew(T entity, boolean isImport) throws NetsharpException {
	...
	public boolean persist(T entity) throws NetsharpException {
		if (entity instanceof Entity) {
	...
	public boolean persist(T entity, boolean isimport) throws NetsharpException {
	...
	public boolean persist(T entity, String[] properties) throws NetsharpException {
		return this.persist(entity, properties, this.isImport);
	}

	public boolean persist(T entity, String[] properties, boolean isimport) throws NetsharpException {
		...
		// {
		// wheres.add("Ts=@Ts");
		// qps.Add("@Ts", entity.Ts, Class<Date>.class);
		// }
	...
	public boolean delete(T entity) throws NetsharpException {
	...
	public boolean delete(String entityName, String filter, QueryParameters qps) throws NetsharpException {
	...
	public boolean isExsist(T entity) throws NetsharpException {
		Mtable meta = MtableManager.getMtable(entity.getClass());
	...
	protected int execute(T entity, SqlGeneratorType operationType, boolean isimport) throws NetsharpException {
		Mtable meta = MtableManager.getMtable(entity.getClass());
	...
	public boolean save(T entity) throws NetsharpException {
		return this.save(entity, false);

	}

	public boolean audit(T entity) throws NetsharpException {

		return true;
	}

	public boolean unAudit(T entity) throws NetsharpException {

		return true;
	}

	public boolean save(T entity, boolean changedProperties) throws NetsharpException {
	...
	private void saveNew(T entity) throws NetsharpException {
	...
	private void saveDelete(T entity) throws NetsharpException {
	...
	private void saveUpdate(T entity, boolean changedProperties) throws NetsharpException {
	...
	@SuppressWarnings("unchecked")
	public List<T> queryList(Oql oql) throws NetsharpException {
	...
	public DataTable queryTable(Oql oql) throws NetsharpException {
	...
	public T queryFirst(Oql oql) throws NetsharpException {
	...
	public int queryCount(Oql oql) throws NetsharpException {
	...
	public Paging queryIndex(Oql oql) throws NetsharpException {
		if (oql.getTag() == null) {
	...
	public ResultSet executeReader(String cmdText, QueryParameters qps) throws NetsharpException {
		this.open();
		return dao.executeResultSet(cmdText, qps);
	}

	public DataTable executeTable(String cmdText, QueryParameters qps) throws NetsharpException {
	...
	public Set executeSet(String cmdText, QueryParameters qps) throws NetsharpException {

		this.open();
		Set set = dao.executeSet(cmdText, qps);
		this.autoClose();
		return set;
	}

	public int executeNonQuery(String cmdText, QueryParameters qps) throws NetsharpException {
		this.open();
	...
	public Object[] executeInsert(String cmdText, QueryParameters qps) throws NetsharpException {
		this.open();
	...
	public Object executeScalar(String cmdText, QueryParameters qps) throws NetsharpException {
	...
	public void autoClose() throws NetsharpException {
	...
	public void close() throws NetsharpException {
