...
public abstract class AbstractQuery {
	...
	public TSet query(Oql oql) throws NetsharpException {
		logger.debug(oql.toString());
	...
	protected abstract TSet queryOnece() throws NetsharpException;

	protected abstract TSet queryPaging() throws NetsharpException;

	public int getTotalCount(OqlStruct os, Oql oql) throws NetsharpException {
...
//		.append(os.Mtable.getTableName()).append(" AS ").append(os.Mtable.getCode()).append(Oql.WithNolock()).append(StringManager.NewLine);
	...
	public ArrayList<String> createPaging(OqlStruct os) throws NetsharpException {
