...
public class Db implements IDb {
	...
	public boolean isTableExsist(String tableName){
		...
		String cmdText = "SELECT count(0) FROM `INFORMATION_SCHEMA`.`TABLES`  WHERE table_schema='" + database + "' AND table_name='" + tableName + "'";
    ...
    public List<Class<?>> getAllPersistableEntities(){
		...
		for(String pack : Application.getContext().getPackagesToScan()){
